 ...
 * @package Make
 */
global $ttfmake_current_location, $post;
...
if ( $ttfmake_current_location === $author_option && ! has_post_format( array('link','video' ) ) ):
	get_template_part( 'partials/entry', 'author' );
endif;

if ( $ttfmake_current_location === $comment_count_option && ! has_post_format( array('link','video' ) ) ):
